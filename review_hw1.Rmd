...
key things: a vector is a sequence of things. think of a excel sheet row. 
character means its a thing, numeric vector is numbers. when you use `factor` 
then `c()` right after to list our the things you are factoring into levels.
...
the last mean will **not** work because you can't pull the mean from characters
